...
func (cu *CourseUpdate) SetCourseLocation(s string) *CourseUpdate {
	cu.mutation.SetCourseLocation(s)
	return cu
}
...
func (cu *CourseUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := cu.mutation.CourseLocation(); ok {
...
// SetCourseLocation sets the "course_location" field.
func (cuo *CourseUpdateOne) SetCourseLocation(s string) *CourseUpdateOne {
	cuo.mutation.SetCourseLocation(s)
	return cuo
}
...
func (cuo *CourseUpdateOne) sqlSave(ctx context.Context) (_node *Course, err error) {
	...
	if value, ok := cuo.mutation.CourseLocation(); ok {
		_spec.SetField(course.FieldCourseLocation, field.TypeString, value)
	}
