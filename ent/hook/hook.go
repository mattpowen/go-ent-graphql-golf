...
// The HoleFunc type is an adapter to allow the use of ordinary
// function as Hole mutator.
type HoleFunc func(context.Context, *ent.HoleMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f HoleFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.HoleMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.HoleMutation", m)
}
...
// The TeeFunc type is an adapter to allow the use of ordinary
// function as Tee mutator.
type TeeFunc func(context.Context, *ent.TeeMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f TeeFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.TeeMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.TeeMutation", m)
}
